...
class InscripcionEvento extends Eloquent {
    ...
    public static $rules = array(
        ...
        //'documento' => 'required|integer|between:1000000,99999999|unique_with:inscripcion_evento,oferta_formativa_id,tipo_documento_cod,documento',
        'documento' => 'required|between:7,15|unique_with:inscripcion_evento,oferta_formativa_id,tipo_documento_cod,documento',
