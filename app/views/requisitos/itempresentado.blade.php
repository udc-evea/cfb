...
<a href="{{ route('ofertas.inscripciones.requisito_borrar', array($oferta->id, $inscripcion->id, $pres1->id)) }}" class="btn btn-default btn-sm action-borrar" data-method="delete" data-remote="true"><span class="glyphicon glyphicon-remove"></span></a>
@else
...
<input type="text" id="fecha_presentacion_{{$requisito->id}}" name="fecha_presentacion" class="input-sm form-control fecha"/>
