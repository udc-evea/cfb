    ...
    @endif
        ...
        <div class="well" style="margin-top: 20px">
            ...
            <p> 
                ...
                información de los alumnos: <a href="{{ URL::asset('img/alumnos.xlsx') }}"><i class="fa fa-file-excel-o fa-3"></i> Archivo de ejemplo. ({{ URL::asset('img/alumnos.xlsx') }})</a>
            </p>
            <p> 
                ...
                <li><a href="{{ URL::asset('img/tipo_DNI.xlsx') }}"><i class="fa fa-file-excel-o fa-3"></i> Tipo DNI correcto. ({{ URL::asset('img/tipo_DNI.xlsx') }})</a></li>
                <li><a href="{{ URL::asset('img/localidades.xlsx') }}"><i class="fa fa-file-excel-o fa-3"></i> Localidades correctas.({{ URL::asset('img/localidades.xlsx') }})</a></li>
            </p>
        </div>
