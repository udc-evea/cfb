    ...
    @endif
        ...
        <div class="well" style="margin-top: 20px">
            ...
            <p> 
                ...
                información de los alumnos: <a href="{{public_path()}}/public/img/alumnos.xlsx"><i class="fa fa-file-excel-o fa-3"></i> Archivo de ejemplo.</a>
            </p>
            <p> 
                ...
                <li><a href="{{public_path()}}/public/img/tipo_DNI.xlsx"><i class="fa fa-file-excel-o fa-3"></i> Tipo DNI correcto.</a></li>
                <li><a href="{{public_path()}}/public/img/localidades.xlsx"><i class="fa fa-file-excel-o fa-3"></i> Localidades correctas.</a></li>
            </p>
        </div>
